...
1. **[geodata](https://cran.r-project.org/web/packages/geodata/index.html)**: acesso a dados globais de clima, altitude, solo, ocorrência de espécies e limites administrativos
1. **[rworldmap](https://cran.r-project.org/web/packages/rworldmap/index.html)**: dados globais
